...
const Icon = ({ styles, name, imgUrl, isActive, disabled, handleClick }) => (
  <div
    className={` w-[48px] h-[48px] rounded-full ${
      isActive && isActive === name && `bg-[${Colors.gray}]`
...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center sticky top-5 h-[93vh] ">
      <Link to="/">
        <Icon
          styles={` w-[52px] h-[52px] bg-[#222] duration-100 hover:bg-[#ddd]  `}
          imgUrl={logo}
        />
      </Link>
      ...
      >
        ...
        <Icon
          imgUrl={sun}
          styles="bg-[#373737] mt-2 shadow-secondary"
        />
      </div>
    </div>
  );
